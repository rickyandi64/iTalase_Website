...
class Rajaongkir extends CI_Controller{
    ...
    private $api_key = '309245d44d763387a25781140c6a8705';
...
//              echo '</pre>';
        ...
        public function kota(){
            $id_pronvinsi_terpilih = $this->input->post('id_provinsi');
            
            $curl = curl_init();
            
            curl_setopt_array($curl, array(
              CURLOPT_URL => "https://api.rajaongkir.com/starter/city?province=". $id_pronvinsi_terpilih,
              CURLOPT_RETURNTRANSFER => true,
              CURLOPT_SSL_VERIFYHOST => 0,
              CURLOPT_SSL_VERIFYPEER => 0,
              CURLOPT_ENCODING => "",
        ...
        public function paket(){
            $id_kota_asal =  $this->Model_Admin->data_setting()->lokasi;
