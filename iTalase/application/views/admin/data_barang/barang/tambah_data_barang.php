		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				<div class="page-header">
					...
					<?php
                                        echo form_open_multipart('barang/tambah_data_barang');
                                        ?>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Nama Barang</label>
							<div class="col-sm-12 col-md-10">
                                                            <input class="form-control" type="text" name="nama_barang" placeholder="Masukan Nama Barang" value="<?php set_value('nama_barang')?>">
...
//                                                                            echo "<option value='$s->id_supplier'>$s->name</option>";
//                                                                        }
                                                                        ?>
								</select>
							</div>
							...
							<div class="col-sm-12 col-md-10">
                                                            <input class="form-control" type="text" name="harga_jual" placeholder="Masukan Harga Jual Barang" value="<?php set_value('harga_jual')?>">
							...
							<div class="col-sm-12 col-md-10">
                                                            <input class="form-control" type="text" name="harga_modal" placeholder="Masukan Harga Modal Jual Barang" value="<?php set_value('harga_modal')?>">
                                                                 <?php echo form_error('harga_modal','<small class="text-danger pl-3">','</small>')?>
                                                        </div>
                                                        
						</div>
                                                <div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Berat Barang</label>
							<div class="col-sm-12 col-md-10">
                                                            <input class="form-control" type="text" name="berat" placeholder="Masukan Berat Barang (Gram)" value="<?php set_value('harga_jual')?>">
							...
							<div class="col-sm-12 col-md-10">
                                                            <textarea class="form-control" type="text" name="desc" placeholder="Masukan Deskripsi Barang" value="<?php set_value('desc')?>"></textarea>
							...
							<div class="col-sm-12 col-md-10">
                                                            <input type="number" class="form-control" type="text" name="jumlah_stok" placeholder="Masukan Jumlah Stok Barang" value="<?php set_value('jumlah_stok')?>">
							...
							<div class="col-md-4">
								<div class="form-group">
									<img src="<?php echo base_url('assets/img/upload.png')?>" alt="" width="250px"  id="uploadPreview" class="img-thumbnail">
