				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-12 col-sm-12">
                            ...
                            <div class="row">
                                <div class="col-lg-9">
                                      <?php echo form_open_multipart('user/tambah_data_user');?>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" id="name" name="name" placeholder="Masukan Nama Lengkap anda" >
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" id="nama_usaha" name="nama_usaha" placeholder="Masukan Nama Usaha anda">
