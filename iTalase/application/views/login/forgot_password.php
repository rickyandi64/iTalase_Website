		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-md-6 col-lg-7">
					<img src="<?php echo base_url()?>assets/login/src/images/forgot_password.png" alt="" height="300">
				</div>
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h2 class="text-center text-primary">Lupa Password iTalase</h2>
						</div>
						...
						<form method="post" action="<?php echo base_url('auth/forgot_password')?>">
							...
							<div class="row">
								<div class="col-sm-12">
									...
									<div class="input-group mb-0">
										<a class="btn btn-outline-primary btn-lg btn-block" href="<?php echo base_url().'auth/login'?>">Kembali ke Login</a>
									</div>
								</div>
							</div>
						</form>
