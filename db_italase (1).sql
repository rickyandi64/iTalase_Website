...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 03 Nov 2021 pada 14.27
...
CREATE TABLE `barang` (
  ...
  `status_kelola` varchar(128) NOT NULL,
...
--
ALTER TABLE `barang`
  ADD CONSTRAINT `barang_ibfk_1` FOREIGN KEY (`id_produk`) REFERENCES `produk` (`id_produk`);
